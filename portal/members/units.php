...
<head>
  ...
  <title>Lecturer Portal | Units</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="callout callout-info">
                 <h6><center>The following units have been approved by the head of department and the Dean's office.</center></h6>
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control">
                        ...
                        <option value="#unit1">2021/22</option>
                        <option value="unit#2">2022/23</option>
                      </select>
                    </div>
                  </div>
                 </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Allocated units</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
