...
<head>
  ...
  <title>Lecturer Portal | Marks</title>
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Add Marks</a></li>
                 ...
                 <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <select id="units" name="units" class="form-control" onchange="verify()">
...
?>        
                    ...
                    <div class="form-group">
                      ...
                      <select id="aunits" name="aunits" class="form-control" onchange="getstudents()">
        ...
        <form role="form">
          ...
          <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
             <button type='button' id='rev-$studreg' name='rev' class='btn btn-primary rev' data-toggle='modal'>Submit</button>
          </div>
        </form>
      </div>
      <!-- /.modal-content -->
...
if(document.getElementById('units')=="")
{
  ...
  function getstudents(){
    jQuery.ajax({
      url:"adddata.php",
      data: 'units='+$("#units").val()+'aunits='+$("#aunits").val(),
      type: "POST",
