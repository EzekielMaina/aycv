...
if($query){
        ...
        $query3 = mysqli_query($conn,$sql3);
 		 ...
 		 $sql2 = "INSERT INTO student(stud_reg,stud_name,stud_mail,stud_gender,fee_balance,stud_session,course_id,room_id,stage_id,nid) VALUES('$fname','$regno','$smail','$gender',$fee,'registered',$courseid,$roomid,$stageid,'$nid');";
